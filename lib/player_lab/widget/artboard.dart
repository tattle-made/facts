...
class _ArtBoardState extends State<ArtBoard> {
  ...
  Widget build(BuildContext context) {
    return imageBrushMask != null ?Column(
      children: [
        GestureDetector(
          child: SizedBox(
            ...
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(6),
                child: CustomPaint(
                  painter: Compositor(playerLab: widget.playerCanvas, tex2:imageBrushMask),
                ),
              ),
            ),
          ),
          onPanStart: (details){
            ...
            paths.setDimension(MediaQuery.of(context).size.width.floor(), (170 / 297 * MediaQuery.of(context).size.width).floor());
          },
          onPanEnd: (details){
            // print("pan up");
        ...
        LayerControls(
            controls: widget.playerCanvas.layers![widget.playerCanvas.selectionIndex].controls,
